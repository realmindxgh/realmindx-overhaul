...
class Config:
    ...
    WHATSAPP_BUSINESS_PHONE_E164 = os.getenv("WHATSAPP_BUSINESS_PHONE_E164", "+233257125229")
    WHATSAPP_SUPPORT_PHONE_E164 = os.getenv("WHATSAPP_SUPPORT_PHONE_E164", "+233201166122")
    WHATSAPP_SUPPORT_PHONE_DISPLAY = os.getenv("WHATSAPP_SUPPORT_PHONE_DISPLAY", "+233 20 116 6122")
    WHATSAPP_WEBHOOK_VERIFY_TOKEN = os.getenv("WHATSAPP_WEBHOOK_VERIFY_TOKEN", "")
    WHATSAPP_APP_SECRET = os.getenv("WHATSAPP_APP_SECRET", "")
    WHATSAPP_PHONE_VERIFICATION_ENABLED = _bool_env("WHATSAPP_PHONE_VERIFICATION_ENABLED", False)
    WHATSAPP_PHONE_VERIFICATION_ALLOW_ALL = _bool_env("WHATSAPP_PHONE_VERIFICATION_ALLOW_ALL", False)
    WHATSAPP_PHONE_VERIFICATION_TEST_EMAILS = os.getenv("WHATSAPP_PHONE_VERIFICATION_TEST_EMAILS", "")
