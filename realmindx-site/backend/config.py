...
class Config:
    ...
    WHATSAPP_PHONE_VERIFICATION_ENABLED = _bool_env("WHATSAPP_PHONE_VERIFICATION_ENABLED", True)
    WHATSAPP_PHONE_VERIFICATION_ALLOW_ALL = _bool_env("WHATSAPP_PHONE_VERIFICATION_ALLOW_ALL", True)
