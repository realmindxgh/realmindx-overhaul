...
DEFAULT_SITE_COPY = [
    ...
    {
        "id": "bookshop_about_title",
        "key": "bookshop_about_title",
        "label": "Bookshop about page title",
        "value": "About RealMindX Bookshop.",
        "area": "bookshop",
        "status": "published",
    },
    {
        "id": "bookshop_about_story",
        "key": "bookshop_about_story",
        "label": "Bookshop about story",
        "value": "RealMindX Bookshop is the retail arm of RealMindX Education Limited - Ghana's comprehensive educational services provider. We exist to put the right learning materials into the hands of every student, parent and teacher, at prices that make sense.\n\nFrom curriculum titles to past questions, readers and stationery, every item we stock is chosen with one question in mind: does this help a Ghanaian learner thrive?",
        "area": "bookshop",
        "status": "published",
    },
    {
        "id": "bookshop_about_inventory",
        "key": "bookshop_about_inventory",
        "label": "Bookshop what-we-sell text",
        "value": "Textbooks for multiple curricula, BECE and WASSCE past questions, graded readers, exercise books, mathematical sets, art supplies and everyday stationery are available at both wholesale and retail prices.",
        "area": "bookshop",
        "status": "published",
    },
    {
        ...
        "label": "Bookshop delivery policy",
        "value": "Orders are dispatched as quickly as stock and payment allow. Delivery fees are calculated at checkout based on the selected location, and free pickup is available at our Dome Pillar 2 shop.",
        "area": "bookshop",
        "status": "published",
    },
    {
