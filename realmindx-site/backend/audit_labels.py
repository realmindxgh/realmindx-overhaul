...
ACTION_LABELS = {
    ...
    "create_admin_order": "Created an order from the management portal",
    ...
    "create_sales_invoice": "Created a payable sales invoice",
    ...
    "invoice_payment_started": "Started an online invoice payment",
    "duplicate_invoice_payment_confirmed": "Detected a duplicate invoice payment",
    ...
    "record_sales_invoice_payment": "Recorded an offline invoice payment",
    ...
    "teacher_profile_reverification_requested": "Submitted an approved teacher profile for re-verification",
    "teacher_account_admin_updated": "Changed a teacher account on behalf of the teacher",
    "teacher_verification_admin_updated": "Changed teacher verification on behalf of RealMindX",
    "teacher_document_admin_uploaded": "Uploaded a teacher document on behalf of the teacher",
    "teacher_document_viewed": "Viewed a teacher document",
    "void_sales_invoice": "Voided a sales invoice",
