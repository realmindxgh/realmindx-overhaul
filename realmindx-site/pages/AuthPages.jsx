          ...
          {mode === 'login' && !success && !pendingVerificationEmail && (
            <>
              ...
              <div className="social-login-grid">
                <button className="social-login-btn google" type="button" onClick={() => { window.location.href = '/api/auth/google'; }}>
                ...
                <button className="social-login-btn facebook" type="button" onClick={() => { window.location.href = '/api/auth/facebook'; }}>
