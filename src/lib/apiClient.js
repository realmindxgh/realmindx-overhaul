...
export const api = {
  ...
  adminResetCompanyUserPassword: (companyUserId, password) => apiFetch(`/admin/delivery-company-users/${companyUserId}/reset-password`, { method: 'POST', body: { password } }),
  ...
  deliveryCompanyResetRiderPassword: (riderId, password) => apiFetch(`/delivery/company/riders/${riderId}/reset-password`, { method: 'POST', body: { password } }),
